...
- Scripture comes from `https://api.getbible.net`, `https://query.getbible.net`, and `https://search.getbible.net`, and the global bookmark topics from `https://bookmarks.getbible.net`;
