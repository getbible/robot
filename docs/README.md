...
- [Search](SEARCH.md) — the public Search API, the filter vocabulary, pagination and exact totals, the Mini App's direct search, and the robot's Telegram-native client.
